...
<body id="tip">
		    ...
		    <div class="row dash-cols">
				...
				<div class="col-sm-6 col-md-6">
					<div class="block">
						<div class="header no-border">
							<h2>Major Audit Finding (Ytd) by Cause<font style="text-shadow: orange;font-size: 200%; font-weight: bold;color: red"> (SAMPLE)</font></h2>
						</div>
				...
				<div class="col-sm-6 col-md-6">
					<div class="block">
						<div class="header no-border">
							<h2>Audit by Program Type <font style="text-shadow: orange;font-size: 200%; font-weight: bold;color: red">(SAMPLE)</font></h2>
						</div>
						<div class="content">
						<h4>Corporate</h4>
							<div class="progress">
						...
						<div class="content no-padding">
							<table class="red">
								<thead>
									<tr>
										<th>Name</th>
										<th class="right"><span>59%</span>Improve</th>
										<th class="right"><span>41%</span>Minor</th>
										<th class="right"><span>0%</span>Major</th>
									</tr>
								</thead>
								<tbody class="no-border-x">
									<tr>
										<td style="width:40%;"><i class="fa fa-sitemap"></i> Corporate</td>
										<td class="text-right">4</td>
										<td class="text-right">2</td>
										<td class="text-right">1</td>
									</tr>
									<tr>
										<td><i class="fa fa-tasks"></i> ISO 14001</td>
										<td class="text-right">3</td>
										<td class="text-right">1</td>
										<td class="text-right">0</td>
									</tr>
									<tr>
										<td><i class="fa fa-signal"></i> ISO 45001</td>
										<td class="text-right">11</td>
										<td class="text-right">3</td>
										<td class="text-right">0</td>
									</tr>
									<tr>
										<td><i class="fa fa-bolt"></i> Workplace Safety</td>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block">
						<div class="header">							
							<h3>Audit Actions Assigned to Me <font style="text-shadow: orange;font-size: 200%; font-weight: bold;color: red">(SAMPLE)</font></h3>
						</div>
						<div class="content">
							<div class="table-responsive">
								<div id="datatable_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-sm-12"><div class="pull-right"><div id="datatable_filter" class="dataTables_filter"></div></div><div class="pull-left"><div class="dataTables_length" id="datatable_length"></div></div><div class="clearfix"></div></div></div><table aria-describedby="datatable_info" class="table table-bordered dataTable" id="datatable">
									<thead>
										<tr role="row">
											<th aria-label="ID: activate to sort column descending" aria-sort="ascending" style="width: 47px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting_asc">ID</th>
											<th aria-label="Type: activate to sort column ascending" style="width: 344px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Type</th>
											<th aria-label="Severity: activate to sort column ascending" style="width: 87px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Severity</th>
											<th aria-label="Status: activate to sort column ascending" style="width: 303px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Status</th>
											<th aria-label="Occured Date: activate to sort column ascending" style="width: 146px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Occured Date</th>
											<th aria-label="Location: activate to sort column ascending" style="width: 129px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Location</th>
											<th aria-label="Created By: activate to sort column ascending" style="width: 169px;" colspan="1" rowspan="1" aria-controls="datatable" tabindex="0" role="columnheader" class="sorting">Created By</th>
										</tr>
									</thead>
