			...
			<table class="table table-bordered table-responsive dataTableSC">
			  <thead>
			    ...
			    <tr>
			      ...
			      <th><fmt:message key="delay" /></th>
			      <th><fmt:message key="reportType" /></th>
			      <th><fmt:message key="receiver1" /></th>
			      <th><fmt:message key="receiver2" /></th>
			      <th style="display:none"><fmt:message key="delete" /></th>
			    </tr>
			    </c:if>
			  </thead>
			  ...
			  <tbody>
					<c:forEach items ="${result.results}"  var="criteria" varStatus="s" >
						<c:choose>
						 ...
						 <tr class="${style }">
						  	...
						  	<td  > 
						  		<c:out value="${criteria.delay}" /> 
						  	</td>
						  	
						  	<td  > 
						  		<c:out value="${criteria.reportType}" />
						  	</td>
						  	<td  > 
						  		<c:out value="${criteria.receiver1}" />
						  	</td>
						  	<td  > 
						  		<c:out value="${criteria.receiver2}" />
						  	</td>
						  	<td  style="font-weight:bold; width:20%;display:none"> 
				  ...
				  <tfoot>
					    ...
					    <tr>
					      <td colspan="7"> <fmt:message key="search.empty" /></td>
					    </tr>
					    </c:if>
					 </tfoot>
				</table>
