...
<body>
<div class="header">
<h2><fmt:message key="wasteShipmentDocumentView" /></h2>
</div>
<div class="content">
<div class="header">
<h3><fmt:message key="wasteShipmentDocument" /></h3>
</div>
<div class="content">
...
<tbody>
  ...
  <tr>
    ...
    <td><c:out value="${document.shipmentNo}" /></td>
  </tr>
  <tr>
    <td ><fmt:message key="wasteShipmentDocument.receivedDate" />:</td>
    <td><fmt:formatDate value="${document.receivedDate}" pattern="dd-MMM-yyyy" /></td>
  </tr>
  <tr>
...
<tfoot>
  <tr>
  	<td colspan="2">
  		<common:bindURL editable="${urls != null}" name="wasteShipmentDocument" site="${document.consignment.site.name}">
