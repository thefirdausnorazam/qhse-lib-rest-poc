...
<script type="text/javascript" >
	if('${imageEncoded}' == '') {
		location.href = 'thirdPartyView.htm?id=${thirdPartyId}';
	}
</script>
</head>
...
<div class="table-responsive">
  <table class="table table-bordered table-responsive">
    ...
    <tbody>
      <tr class="form-group">
        <td class="searchLabel" style="width:30%"><fmt:message key="name" />:</td>
        <td class="search"><c:out  value="${command.name }"/></td>
      </tr>
      <tr class="form-group">
        <td class="searchLabel" ><fmt:message key="company" />:</td>
        <td class="search"><c:out  value="${command.company }"/></td>
      </tr>
      <tr class="form-group">
        <td class="searchLabel" ><fmt:message key="address" />:</td>
        <td class="search"><c:out  value="${command.address }"/></td>
      </tr>
