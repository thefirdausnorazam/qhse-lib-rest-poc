...
<head>
  ...
  <title><fmt:message key="healthTestQueryForm.title" /></title>
...
<form action="<c:url value="/health/testView.htm" />" method="get" onsubmit="if(!$F('gotoId')) return false;">
...
<scannell:form id="queryForm" action="/health/testQueryResult.htmf" onsubmit="updateSearchCriteriaSummary(); displayQueryTable(false); return search(this, 'resultsDiv');">
...
<tbody id="searchCriteria">
  ...
  <tr>
    <th id="testDateFromLabel"><fmt:message key="healthTest.testDate" /> <fmt:message key="from" />:</th>
    <td>
      <input name="testDateFrom" id="testDateFrom" readonly="true" />
      <img src="<c:url value="/images/calendar.gif"/>" alt="show-calendar" onclick="return showCalendar(event, 'testDateFrom', true);">
    </td>

    <th id="testDateToLabel"><fmt:message key="to" />:</th>
    <td>
      <input name="testDateTo" id="testDateTo" readonly="true" />
      <img src="<c:url value="/images/calendar.gif"/>" alt="show-calendar" onclick="return showCalendar(event, 'testDateTo', true);">
    </td>
  </tr>

  <tr>
    <th id="retestDateFromLabel"><fmt:message key="healthTest.retestDate" /> <fmt:message key="from" />:</th>
    <td>
      <input name="retestDateFrom" id="retestDateFrom" readonly="true" />
      <img src="<c:url value="/images/calendar.gif"/>" alt="show-calendar" onclick="return showCalendar(event, 'retestDateFrom', true);">
    </td>

    <th id="retestDateToLabel"><fmt:message key="to" />:</th>
    <td>
      <input name="retestDateTo" id="retestDateTo" readonly="true" />
      <img src="<c:url value="/images/calendar.gif"/>" alt="show-calendar" onclick="return showCalendar(event, 'retestDateTo', true);">
    </td>
  </tr>
