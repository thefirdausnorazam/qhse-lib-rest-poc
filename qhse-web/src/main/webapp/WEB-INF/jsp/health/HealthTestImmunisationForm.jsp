...
<html>
<head>
  <title><fmt:message key="healthTestImmunisationForm.title" /></title>
...
<tbody>
  ...
  <tr>
    <td class="label"><fmt:message key="healthTestImmunisation.type" />:</td>
    <td colspan="3">
			<select name="type" renderEmptyOption="true">
				<scannell:option value="Hepatitis B" />
				<scannell:option value="Polio" />
				<scannell:option value="Rubella" />
				<scannell:option value="Tetanus" />
				<scannell:option value="Tuberculosis" />
			</scannell:select>
