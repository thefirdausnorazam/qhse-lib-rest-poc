...
<form id="form" class="g-form" action="<c:out value="${contextURL}/login" />" target="_top" method="POST">
	<div class="row">
		<div class="col-md-12">
			<div class="g-form__element">
				<label class="g-label"><spring:message code="userNameOneword"/></label>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="g-form__element">
				<label class="g-label"><spring:message code="password"/></label>
				<div class="g-input g-input--fluid">
	...
	<div class="row">
		<div class="col-md-12 text-right">
			<button type="button" 
					...
					data-toggle="tooltip" 
					title="<spring:message code="use.sso.tooltip"/>"><spring:message code="use.sso"/></button>
		</div>
	</div>
	</c:if>
</form>
