...
<tbody>
  ...
  <tr>
    <td>
      <a href="<c:url value="addLawAttachment.htm"><c:param name="itemId" value="${item.id}" /><c:param name="showId" value="${ownerId}" /></c:url>"><c:out value="${item.name}" /></a>
    ...
    <td>
      <scannell:text value="${item.description}" htmlEscape="true" /></td>   
  ...
  <tr>
    <td colspan="5">
        <a href="<c:url value="addLawAttachment.htm"><c:param name="showId" value="${ownerId}"/></c:url>">
