...
<%@ taglib prefix="law" tagdir="/WEB-INF/tags/law" %>
    ...
    jQuery.ajaxSetup({
      ...
      var legislationId='<c:out value="${legislationId}"/>';
      scansol = {}; // namespace
	  function collapseChecklists() {
          ...
          $jq("div.checklist-toggleall a").click(function() {
    	        ...
    	        if(expand == '+'){
    	        	...
    	        	window.location.href=contextPath+'/law/relevance.htm?legId='+legislationId+'&viewAll=true&viewType=relevant&legRegister='+legRegister+'&profileId='+profileId;
    	        }else{
    	        	window.location.href=contextPath+'/law/relevance.htm?legId='+legislationId+'&viewAll=true&viewType=notRelevant&legRegister='+legRegister;
    	        }
    	        return false;
          });
