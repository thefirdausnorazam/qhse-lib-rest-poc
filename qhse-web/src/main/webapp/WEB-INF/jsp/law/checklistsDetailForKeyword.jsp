...
jQuery(document).ready(function(){
   ...
   if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	var ch = jQuery('.dataDetails').attr("checklist") ;	
	 var url = contextPath+"/law/showChecklistDetail.htmf?checklistId="+ch+"&profileId=0";
     ...
     if(getURLParam('comeFromRisk') == 'true'){
    	 ...
    	 var hiddenProfile= jQuery('<input type="hidden" id="profileSelect" name ="profileSelect" value="0"/>');
				...
				<c:if test="${fn:length(checklistsByCategory) < 1}">
					<div id="riskMsgError" style="display:none;">
						...
						<div style="margin-top: 20px">
							...
							<p>enviroLAW © <a href="http://www.scannellsolutions.com"><font style="color: #0066CC;">SCANNELL SOLUTIONS</font></a></p>
						</div>
					</div>
				</c:if>
				</div>			
