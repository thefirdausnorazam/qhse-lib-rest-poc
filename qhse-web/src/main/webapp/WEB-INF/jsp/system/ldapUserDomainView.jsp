...
<h2><fmt:message key="userDomainView" /> : <c:out value="${domain.name}" />
      <c:if test="${lastSyncBy != null}">
      		(Last synchronised by <c:out value="${lastSyncBy}" /> on <fmt:formatDate value="${lastSyncTs}" pattern="dd-MMM-yyyy HH:mm"  />)
      </c:if></h2>
</div>
<a name="user"></a>
<div class="content">
...
<tbody>
  ...
  <tr>
    <td><fmt:message key="userDomain.url" /></td>
    <td><c:out value="${domain.url}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.rootDn" /></td>
    <td><c:out value="${domain.rootDn}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.userName" /></td>
  ...
  <c:if test="${!empty domain.spnegoKeytabLocation}">
	 <tr>
	   <td><fmt:message key="userDomain.spnegoKeytabLocation" /></td>
	   <td><c:out value="${domain.spnegoKeytabLocation}" /></td>
	 </tr>
  </c:if>
  <c:if test="${!empty domain.spnegoServicePrincipal}">
	  <tr>
	    <td><fmt:message key="userDomain.spnegoServicePrincipal" /></td>
	    <td><c:out value="${domain.spnegoServicePrincipal}" /></td>
	  </tr>
  </c:if>
  <tr>
    <td><fmt:message key="userDomain.ignoreDepartmentAttribute" /></td>
    <td><fmt:message key="${domain.ignoreDepartmentAttribute}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.autoSync" /></td>
    <td><fmt:message key="${domain.autoSync}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.userSearchBase" /></td>
    <td><c:out value="${domain.userSearchBase}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.groupSearchBase" /></td>
    <td><c:out value="${domain.groupSearchBase}" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><fmt:message key="userDomain.employeeIdProperty" /></td>
    <td><c:out value="${domain.employeeIdProperty}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.activeUsers" /></td>
    <td><c:out value="${activeUserCount}" /></td>
  </tr>
  <tr>
    <td><fmt:message key="userDomain.totalUsers" /></td>
    <td><c:out value="${totalUserCount}" /></td>
  </tr>
  <tr>
