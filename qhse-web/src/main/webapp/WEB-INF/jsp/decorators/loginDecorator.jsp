...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value="/login/css/style.css?a=a" />">
	<link class="theme-css" rel="stylesheet" href="<c:url value="/login/groove/css/groove-qpulse.min.css" />" />
	...
	<script type="text/javascript" src="<c:url value="/login/js/jquery.js" />"></script>
	<script type="text/javascript" src="<c:url value="/login/js/behaviour/general.js" />"></script>


	<!-- Bootstrap core JavaScript
	================================================== -->
	<!-- Placed at the end of the document so the pages load faster -->
	<script type="text/javascript" src="<c:url value="/login/js/behaviour/voice-commands.js" />"></script>
	<script type="text/javascript" src="<c:url value="/login/js/bootstrap/dist/js/bootstrap.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/login/js/jquery.flot/jquery.flot.js" />"></script>
	<script type="text/javascript" src="<c:url value="/login/js/jquery.flot/jquery.flot.pie.js" />"></script>
	<script src="<c:url value="/login/js/jquery.parsley/dist/parsley.min.js" />" type="text/javascript"></script>
	<script src="<c:url value="/login/js/jquery.parsley/src/extra/dateiso.js" />" type="text/javascript"></script>
	<script type="text/javascript" src="<c:url value="/login/js/jquery.select2/select2.min.js" />"></script>
	<script type="text/javascript" src="<c:url value="/login/js/jquery.niftymodals/js/jquery.modalEffects.js" />"></script>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="g-layout-login__wrapper">
						...
						<!-- Info / Error messages -->
						<div class="row">
							<div class="alert hidden alert-info" id="infoMessageAlert">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<i class="fa fa-info-circle sign"></i>
								<strong></strong>INFO</strong>
								<span id="infoMessage"></span>
							</div>
							<div class="alert hidden alert-danger" id="errorMessageAlert">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<i class="fa fa-times-circle sign"></i>
								<strong>ERROR</strong>
								<span id="errorMessage"><c:if test="${not empty loginError}"><spring:message code="loginErrorMessage"/></c:if></span>
							</div>
						</div>
									...
									<div class="g-container__inner">
										...
										<div class="row">
											<div class="col-md-12 q-pulse-login-logo">
												<img src="<c:url value="/public/images/logo/Q-Pulse7_Med.png" />" />
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												...
												<a class="g-btn g-btn--link" href="<c:out value="/beginSetup.html" />"><spring:message code="setupAccount"/></a>
			...
			<div class="modal-header">
				<div class="row">
					<div class="col-md-12 q-pulse-login-logo-terms">
						<img src="<c:url value="/login/images/logotype.png" />">
					</div>
				</div>
			</div>
