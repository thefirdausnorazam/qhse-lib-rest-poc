...
<div class="panel panel-danger"> 
  <table class="table table-bordered table-responsive">
    ...
    <tbody>
     	<tr class="form-group">
		    <td class="searchLabel" style="width: 50%"><fmt:message key="id" />:</td>
		    <td class="search"><c:out value="${command.id}" /></td>
		  </tr>
		
		  <tr class="form-group">
		    <td class="searchLabel"><fmt:message key="businessArea" />:</td>
		    <td class="search"><c:out value="${command.template.businessArea.name}" /></td>
		  </tr>
		
		  <tr class="form-group">
		    <td class="searchLabel"><fmt:message key="template.name" />:</td>
		    <td class="search" colspan="3"><scannell:text value="${command.template.name}" /></td>
		  </tr>

		<tr class="form-group">
			<td class="searchLabel"><fmt:message key="template.selectAll"/>:</td>
			<td class="search"><input type="checkbox" onClick="toggle(this)" /></td>
		</tr>
	   ...
	   <tr class="form-group">
    	 <td class="searchLabel"><fmt:message key="template.sites"/>:</td>
	      ...
	      <input type="hidden" name="_activeInSites" value="xxx" />
			...
			<input type="hidden" name="activeInSitesPage" value="0">
	      </td>
    </tr>
    </tbody>
    <tfoot>
