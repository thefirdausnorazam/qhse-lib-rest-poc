...
<tbody>
  ...
  <c:forEach items="${riskAssessment.attachments}" var="item">
  
  <tr>
    <td>
      <a href="<c:url value="addRiskAttachment.htm"><c:param name="itemId" value="${item.id}" /><c:param name="showId" value="${riskAssessment.id}" /></c:url>"><c:out value="${item.name}" /></a>
  ...
  <tr>
    <td colspan="7">
     <c:if test="${riskAssessment.editable}">
        <a href="<c:url value="addRiskAttachment.htm"><c:param name="showId" value="${riskAssessment.id}"/></c:url>">
