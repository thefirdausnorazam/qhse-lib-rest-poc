...
<body>
<div class="header">
<h2><span class="nowrap"><fmt:message key="auditPlan" /> - <c:out value="${plan.displayName}" /><!--<fmt:message key="auditPlanView" />--></span></h2>
</div>
<div class="content">
<!-- <div class="header"> -->
<%-- <h3><span class="nowrap"><fmt:message key="auditPlan" /> - <c:out value="${plan.displayName}" /></span></h3> --%>
<!-- </div> -->
<div class="content">
	...
	<tr>
		<td colspan="2">
			<c:choose>
				...
				<c:otherwise><fmt:message key="auditPlan" /> <fmt:message key="notCurrentSelectedSiteMsg" >
...
<tbody>
<c:forEach items="${plan.programmes}" var="programme" varStatus="s">
<c:if test="${programme.programmeStatus != 'TRASH'}">
	<c:choose>
