...
if(('webkitSpeechRecognition' in window)){
  ...
  App.speechCommand('email',{
    ...
    dictationEnd: function(){
      ...
      $('#terms-and-conditions-modal .interim').fadeOut(function(){ $(this).html(""); });     
      progress.appendTo("#terms-and-conditions-modal .modal-body").fadeIn();
      ...
      $("#terms-and-conditions-modal .modal-body h4").html("Thank you!");
      $("#terms-and-conditions-modal .modal-body p").addClass("text-center").html("We are sending a new e-mail...");
    },
    action: function(){
      var modal = $('<div role="dialog" tabindex="-1" id="terms-and-conditions-modal" class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button></div><div class="modal-body"><div class="text-center"><div class="i-circle primary"><i class="fa fa-envelope"></i></div><h4>Tell me your message...</h4><div contenteditable="true"><p class="text-left"><span class="msg"></span><span class="interim color-primary"></span></p></div></div></div><div class="modal-footer"><button data-dismiss="modal" class="btn btn-default" type="button">Cancel</button><button data-dismiss="modal" class="btn btn-primary" type="button">Send</button></div></div></div></div>');
      modal.appendTo("body");
      $('#terms-and-conditions-modal').modal();
      $('#terms-and-conditions-modal').on('hidden.bs.modal', function () {
          $(this).removeData('bs.modal');
          $(this).remove();
      });
    },
    listen: function(r){
      $('#terms-and-conditions-modal .msg').append(" " + r);
      $('#terms-and-conditions-modal .interim').fadeOut(function(){ $(this).html(""); });
    },
    interim: function(r){
      $('#terms-and-conditions-modal .interim').show().html(r);
    }
  });  
