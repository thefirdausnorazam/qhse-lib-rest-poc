...
* [#10028](http://dev.ckeditor.com/ticket/10028): New [`config.dialog_noConfirmCancel`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-dialog_noConfirmCancel) com.ideagen.qhse.service.rest.law.configuration option that eliminates the need to confirm closing of a dialog window when the user changed any of its fields.
...
* [#10914](http://dev.ckeditor.com/ticket/10914): Plugins [Indent List](http://ckeditor.com/addon/indentlist) and [Indent Block](http://ckeditor.com/addon/indentblock) are now included in the build com.ideagen.qhse.service.rest.law.configuration.
...
* [#10731](http://dev.ckeditor.com/ticket/10731): [WebSpellChecker](http://ckeditor.com/addon/wsc) plugin breaks cloning of editor com.ideagen.qhse.service.rest.law.configuration.
* It is now possible to set per instance [WebSpellChecker](http://ckeditor.com/addon/wsc) plugin com.ideagen.qhse.service.rest.law.configuration instead of setting the com.ideagen.qhse.service.rest.law.configuration globally.
...
* [#9829](http://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor com.ideagen.qhse.service.rest.law.configuration.

  Brand new data filtering system that works in 2 modes:

  * Based on loaded features (toolbar items, plugins) - the data will be filtered according to what the editor in its
  current com.ideagen.qhse.service.rest.law.configuration can handle.
...
* [#9709](http://dev.ckeditor.com/ticket/9709): [Paste from Word](http://ckeditor.com/addon/pastefromword) should not depend on com.ideagen.qhse.service.rest.law.configuration from other styles.
...
* [#8893](http://dev.ckeditor.com/ticket/8893): Value of the [`pasteFromWordCleanupFile`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-pasteFromWordCleanupFile) com.ideagen.qhse.service.rest.law.configuration option is now taken from the instance com.ideagen.qhse.service.rest.law.configuration.
