...
var Buttons = function( dt, config )
{
	...
	// For easy com.ideagen.qhse.service.rest.law.configuration of buttons an array can be given
	if ( $.isArray( config ) ) {
...
$.extend( Buttons.prototype, {
	...
	/**
	 * Add a new button
	 * @param {object} config Button com.ideagen.qhse.service.rest.law.configuration object, base string name or function
	 ...
	 * @param {object} conf Resolved button com.ideagen.qhse.service.rest.law.configuration object
	 * @private
	 */
	...
	_expandButton: function ( attachTo, button, inCollection, attachPoint )
	{
		...
		for ( var i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			// If the com.ideagen.qhse.service.rest.law.configuration is an array, then expand the buttons at this
			// point
			if ( $.isArray( conf ) ) {
	 ...
	 * @param  {object} config            Resolved button com.ideagen.qhse.service.rest.law.configuration
	 ...
	 * button is removed)
	 * @param  {object} conf Button com.ideagen.qhse.service.rest.law.configuration
	 * @private
	 */
	...
	/**
	 * Resolve a button com.ideagen.qhse.service.rest.law.configuration
	 * @param  {string|function|object} conf Button config to resolve
	 * @return {object} Button com.ideagen.qhse.service.rest.law.configuration
	 * @private
	 */
	_resolveExtends: function ( conf )
	{
		...
		var toConfObject = function ( base ) {
			...
			// Loop until we have resolved to a button com.ideagen.qhse.service.rest.law.configuration, or an
 ...
 *
 * @param {object}	config Button com.ideagen.qhse.service.rest.law.configuration
