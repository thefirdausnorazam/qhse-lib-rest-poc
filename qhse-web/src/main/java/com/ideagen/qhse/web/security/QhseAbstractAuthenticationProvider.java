...
/**
 * Combines of LDAP and UserDetails Abstract Authentification Provider
 * 
 * @author tatyoong.law
 *
 */
public abstract class QhseAbstractAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
	
	protected final Log logger = LogFactory.getLog(getClass());
	/** Start UserDetails Logics**/
	// ~ Instance fields
	// ================================================================================================
	// 
	...
	/** Combine UserDetails and LDAP Logics according to Qhse logics**/
	public Authentication authenticate(Authentication authentication)
		...
		QhseAuthenticationToken userToken = (QhseAuthenticationToken) authentication;
		// if empty should call JDBC authentication
		if (StringUtils.isEmpty(userToken.getDomain())) {
			//System.out.println("JDBC");
			// Determine username
			String username = (authentication.getPrincipal() == null) ? "NONE_PROVIDED"
					: authentication.getName();
			
			logger.debug("Calling JDBC authentification for '" + username + "'");
		...
		// else call LDAP authentication
		} else {
			
			String username = userToken.getName();
			String password = (String) authentication.getCredentials();

			logger.debug("Calling LDAP authentification for '" + username + "'");
			...
			//TODO: if need to get user roles from JDBC should call the method retrieveUser() based on username here
